...
THREE.StereoEffect = function ( renderer ) {
	...
	this.render = function ( scene, camera ) {
		...
		renderer.setViewport( 0, 0, _width * 2 * window.devicePixelRatio, _height * window.devicePixelRatio);
		renderer.clear();

		renderer.setViewport( 0, 0, _width * window.devicePixelRatio, _height * window.devicePixelRatio);
		renderer.render( scene, _cameraL );

		renderer.setViewport( _width * window.devicePixelRatio, 0, _width * window.devicePixelRatio, _height * window.devicePixelRatio );
